...
namespace Core.Utilities.Security.JWT
{
    ...
    {
        public IConfiguration Configuration { get; } //appsetting'deki TokenOptions bilgisini okumak için
        ...
        private IEnumerable<Claim> SetClaims(User user, List<OperationClaim> operationClaims)
        {
            ...
            //claims.Add(new Claim("email", user.Email)); //Bu kodu yazmak yerine Claims' extend ettik
